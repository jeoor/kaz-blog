...
1. Fork the project.
2. Create a local copy of your fork or clone the current repository.
...
If you have any questions or encounter issues, please open an issue in the current repository or document the context clearly in your PR.
